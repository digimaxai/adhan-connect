...
export default function SettingsScreen() {
  ...
  const isMuezzinPrimary = isMuezzin && !isAdmin && !isLocalAdmin;
  const showUserOnlyItems = !isMuezzin;
  ...
  return (
    ...
    >
      <View style={{ paddingHorizontal: 18, paddingTop: 56, paddingBottom: 18 }}>
        ...
        <Text style={{ fontSize: 27, fontWeight: '800', color: '#0F172A', marginTop: 6 }}>
          Settings
        </Text>
        <Text style={{ fontSize: 15, color: '#475569', marginTop: 6 }}>
          Control notifications and view your duties.
        </Text>
        <View
          style={{
            marginTop: 14,
        ...
        >
          ...
          <Text style={{ marginTop: 4, fontSize: 14, color: 'rgba(255,255,255,0.85)' }}>
            {user?.email ?? 'No email'}
          </Text>
        ...
        <View style={{ marginTop: 20, marginHorizontal: 18 }}>
          ...
          >
            {isMuezzin && (
              <SettingsRow
                title="My Rota"
                subtitle="View your upcoming adhan duties"
                href="/(muezzin)/my-rota"
                last={!isAdmin || isMuezzinPrimary}
              />
            )}

            {!showUserOnlyItems && isAdmin && (
              <SettingsRow
                title="Admin console"
