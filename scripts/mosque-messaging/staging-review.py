"""Rehearse, apply, or verify only the reviewed messaging migrations on staging."""
import argparse
import json
...
NAMES = [
    '20260909000000_mosque_add_requests_admin_self',
    '20260909001000_mosque_messages',
    '20260909002000_harden_mosque_messaging',
]
...
def build_sql(mode):
    ...
    chunks.append((ROOT / 'scripts/mosque-messaging/verify.sql').read_text())
